...
<div class="nk-app-root">
        ...
        <div class="container-xl wide-lg">
          <div class="nk-block-head">
            <div class="nk-block-head-sub mb-3">
              ...
              <span>Mackings Empowerment Initiative</span>
            </div>
                ...
                <ul class="nk-block-tools gx-3">
                  <li>
                    <a href="javascript:void(0)" data-toggle="modal"
                       data-target="#new-savings-account"
                       class="btn btn-primary"><span>New Savings Account</span>
                      <em class="icon ni ni-arrow-long-right"></em>
                    </a>
                  </li>
                  <li>
                    <a href="/loan-application"
                       class="btn btn-white btn-light"><span>New Loan</span>
                      ...
                      <div class="card-inner">
                        <div class="nk-wg7">
                          <div class="nk-wg7-stats">
                            <div class="nk-wg7-title"><?= $regular_savings['name'] ?></div>
                            <div class="number-lg amount"><em
                                class="icon ni ni-sign-kobo"></em> <?= number_format($regular_savings['amount'], 2) ?>
                            </div>
                          </div>
                          <div class="nk-wg7-stats-group">
                            ...
                            <div class="nk-wg7-stats w-100">
                              ...
                              <div class="number"><em
                                  class="icon ni ni-sign-kobo"></em><?= number_format($regular_savings['amount'] - $encumbered_amount,
                                    2) ?>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="nk-wgw sm">
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $pending_withdrawals ?><span
                      ...
                      <div class="card bg-light">
                        <div class="nk-wgw sm">
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $pending_loans ?><span
                                  class="currency currency-nio"> pending</span>
                              </div>
                            </div>
                          </a>
              ...
              <div class="col-md-6">
                <div class="card-head">
                  <div class="card-title  mb-0">
                    <h5 class="title">Outstanding Loans</h5>
                  </div>
                  <div class="card-tools">
                    <ul class="card-tools-nav">
                      <!--                      <li class="active"><a href="#">Mo</a></li>-->
                    </ul>
                  </div>
                </div><!-- .card-head -->
              ...
              <div class="col-md-6">
                ...
                <div class="card card-bordered">
                  <div class="card-inner-group">
                      ...
                      if (empty($savings_types_amounts_list)): ?>
                        <div class="tranx-item">
                          <div class="tranx-col">
                            <div class="tranx-info">
                              <div class="tranx-data">
                                <div class="tranx-label"> No Savings Types</div>
                                <div class="tranx-date">-</div>
                              </div>
                            </div>
                          </div>
                      ...
                      <?php
                      else: foreach ($savings_types_amounts_list as $savings_type => $amount): ?>
                        <div class="card-inner">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="new-savings-account">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
        <div class="modal-body">
          <h5 class="title">New Savings Account</h5>
          <form class="row gy-4 form-validate pt-3" id="new-savings-account-form">
            <div class="col-12">
              <div class="form-group">
                <label class="form-label" for="sa_account_type">Account Type <span
                    class="text-danger">*</span></label>
                <div class="form-control-group">
                  <select class="form-control form-select" data-search="on" name="sa_account_type" id="sa_account_type"
                          required>
                    <option value="0" selected disabled>Select an account type</option>
                      <?php
                      foreach ($contribution_types as $contribution_type): ?>
                        <option
                          value="<?= $contribution_type['contribution_type_id']; ?>"><?= $contribution_type['contribution_type_name']; ?>
                          - Fee: NGN <?= $contribution_type['fee']; ?> </option>
                      <?php
                      endforeach; ?>
                  </select>
                  <div class="alert alert-icon alert-info mt-1 mb-1" role="alert" id="savings-account-fee" hidden>
            ...
            <div class="col-12">
              <div class="form-group">
                <label class="form-label" for="sa_reason">
                  Reason
                  <span class="text-danger">*</span>
                </label>
                <div class="form-control-group">
                  <textarea name="sa_reason" id="sa_reason" rows="5" class="form-control" required></textarea>
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="account-agree">
                  <label class="custom-control-label" for="account-agree">I agree to be charged the account opening fee
                    for this account type as specified above.</label>
                </div>
              </div>
            </div>
            <div class="col-12">

<?php
$session = session();
$loan_details = $finished_loan_details['loan_details'];
$no_activity = $finished_loan_details['no_activity'];
            ...
            <div class="components-preview">
              <div class="nk-block-head nk-block-head-lg wide-sm">
                <div class="nk-block-head-content">
                  <div class="nk-block-head-sub"><a class="back-to" href="<?= site_url('finished-loans') ?>"><em
                        class="icon ni ni-arrow-left"></em><span>Finished Loans</span></a></div>
                  <h2 class="nk-block-title fw-normal">View Finished Loan</h2>
                        ...
                        <div class="card-title-group align-start mb-0">
                          <div class="card-title w-100 d-flex justify-content-between">
                            ...
                            <button class="btn btn-secondary btn-sm"
                                    onclick="exportPdf('slbcoop_finished_loan_<?php
                                    $date = date_create();
